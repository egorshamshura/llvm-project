...
public:
  EmberMCCodeEmitter(const MCInstrInfo &, MCContext &ctx) : Ctx(ctx) {}
  EmberMCCodeEmitter(const EmberMCCodeEmitter &) = delete;
  EmberMCCodeEmitter &operator=(const EmberMCCodeEmitter &) = delete;
  ~EmberMCCodeEmitter() override = default;
...
unsigned EmberMCCodeEmitter::getSImm16OpValue(const MCInst &MI, unsigned OpNo,
                                            SmallVectorImpl<MCFixup> &Fixups,
                                            const MCSubtargetInfo &STI) const {
...
MCCodeEmitter *llvm::createEmberMCCodeEmitter(const MCInstrInfo &MCII,
                                            MCContext &Ctx) {
  return new EmberMCCodeEmitter(MCII, Ctx);
}
