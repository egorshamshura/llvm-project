...
class ELFEmberAsmBackend : public EmberAsmBackend {
  Triple::OSType OSType;

public:
  ELFEmberAsmBackend(const Target &T, Triple::OSType OSType)
...
MCAsmBackend *llvm::createEmberAsmBackend(const Target &T,
  ...
  return new ELFEmberAsmBackend(T, STI.getTargetTriple().getOS());
}